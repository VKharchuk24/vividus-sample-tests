...
When I hover mouse over element located by `xpath(//div[@class='theme-switcher'])`
Then number of elements found by `xpath(//*[text()='Dark Mode']):a` is = `1`
...
When I hover mouse over element located by `xpath(//div[@class='theme-switcher'])`
Then number of elements found by `xpath(//*[text()='Light Mode']):a` is = `1`
